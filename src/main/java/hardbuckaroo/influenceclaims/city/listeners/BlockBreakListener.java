    ...
    public void onBlockBreakEvent(BlockBreakEvent event){
        ...
        if(Arrays.asList(Material.SWEET_BERRY_BUSH, Material.POTATOES, Material.BEETROOTS, Material.WHEAT,
            ...
            if(blockData instanceof Ageable) {
                ...
                Material.CACTUS, Material.RED_MUSHROOM, Material.PUMPKIN, Material.ACACIA_LOG, Material.BIRCH_LOG, Material.CHERRY_LOG,
                Material.DARK_OAK_LOG, Material.JUNGLE_LOG, Material.MANGROVE_LOG, Material.OAK_LOG, Material.SPRUCE_LOG).contains(block.getType()) && cityUUID != null) {
            ...
            if(mostRecentPlacerClaim == null || !mostRecentPlacerClaim.equals(cityUUID)) {
                ...
                manageClaims.subtractTempClaim(chunkKey,cityUUID,blockValue);
                manageClaims.subtractPermClaim(chunkKey,cityUUID,blockValue);
            }
        }
